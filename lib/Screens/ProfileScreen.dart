...
import 'package:appdevproject/Screens/EditProfileScreen.dart';
import 'package:appdevproject/Screens/Splashscreen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  getAllPosts() async {
    List<dynamic> userPostsData =
        await DatabaseServices.getUserPosts(widget.visitedUserId);

    List<Post> userPosts = List<Post>.from(userPostsData);
                ...
                children: [
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: userModel.profilePicture.isEmpty
                            ...
                            : NetworkImage(userModel.profilePicture.toString())
                  ...
                  Container(
                    ...
                    child: CupertinoSlidingSegmentedControl(
                      ...
                      thumbColor: Color.fromARGB(142, 170, 96, 254),
